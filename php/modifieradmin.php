...
<?php
    ...
    $nom=$_POST['nom'];
    $pwd=$_POST['pwd'];
    $req="select * from admin where nom = '$nom' and mdp = '$pwd'";
...
<body>
   ...
   <div class="welc5">
    ...
    <div class="formcontainer">
       <center><label >modifier admin:</label></center>

       <form action="..//php/modifieradmin2.php" method="post">
        <table>
            <tr>
                <td><label for="">Nom</label></td>
                <td> <input required type="text" name="nom" id="nom" value="<?php echo($r[1]) ?>"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input required type="text" name="pwd" id="pwd" value="<?php echo($r[2]) ?>"></td>
