       ...
       <div class="welc6">
        ...
        <div style="width: 40%;  height: 30%; background-color: rgb(217, 238, 26);   position: absolute; top: 26%; left: 29%;">
           <h1 style="color:black; position:absolute; top:18%;">
            ...
            $nom=$_POST['nom'];
            $pwd=$_POST['pwd'];
            $req="delete  from admin where nom='$nom' and  mdp='$pwd'";
            mysql_query($req) or die("erreur suppresion");
            echo(mysql_affected_rows()."admin supprimée");
